...
AWS Lambda runtimes for Python 3.12 and later are based on Amazon Linux 2023, which does not include glibc-gconv-extra, causing “Unicode conversion failed” errors. This Lambda layer resolves this issue.
